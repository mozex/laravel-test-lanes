...
- The design was extracted from a production Laravel app where it ran battle-tested against real concurrent runs; the measured connection budget, the crc32 mask, and the facade-timing trap in this file all come from that deployment. Everything load-bearing from the original spec lives in this file and the README.
